...
public class Actividad3item2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad3item2);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent inten = new Intent(Actividad3item2.this,Principalestudiantes.class);

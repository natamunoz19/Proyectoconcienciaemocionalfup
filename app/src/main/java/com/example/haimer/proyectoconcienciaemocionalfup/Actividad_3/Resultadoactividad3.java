...
public class Resultadoactividad3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultadoactividad3);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,R.array.sonido,android.R.layout.simple_spinner_item);
    ...
    public String buscarestudiante() {
        ...
        String respuesta = "";
        try {
            URL url = new URL("http://"+ipconexion.getIp()+"/dbandroid/WS/resultadoactividad3.php");
    ...
    public void listarestidiandte (String respuesta){
        ...
        try{
            ...
            for (int i = 0;i<jsonarreglo.length();i++){
                ...
                u.setEstadoactividad(jsonarreglo.getJSONObject(i).getString("estado"));
                u.setDiasemana(jsonarreglo.getJSONObject(i).getString("sonido"));
    ...
    private void obtenerlista() {
        ...
        if (listausuario.size() >= 1){
            for (int i =0; i<listausuario.size();i++){
                listainformacion.add(" Documento : "+listausuario.get(i).getDocumento() + "  Nombre : "+listausuario.get(i).getNombre()+" estado : "+listausuario.get(i).getEstadoactividad()+"  sonido : "+listausuario.get(i).getDiasemana()+"  fecha :  "+listausuario.get(i).getFecha());
    ...
    public String buscarestudoc(String doc) {
        ...
        String respuesta = "";
        try {
            URL url = new URL("http://"+ipconexion.getIp()+"/dbandroid/WS/resultadoactividad3documento.php");
            connction = (HttpURLConnection) url.openConnection();
    ...
    public String buscarestudocdia(String doc,String dia) {
        ...
        ipconexion = new Ipconexion();
        String parametros ="documento="+doc+"&sonido="+dia+"";

        HttpURLConnection connction = null;
        String respuesta = "";
        try {
            URL url = new URL("http://"+ipconexion.getIp()+"/dbandroid/WS/resultadoactividad3documentosonido.php");
            connction = (HttpURLConnection) url.openConnection();
            connction.setRequestMethod("POST");
            connction.setRequestProperty("Content-Length",""+Integer.toString(parametros.getBytes().length));

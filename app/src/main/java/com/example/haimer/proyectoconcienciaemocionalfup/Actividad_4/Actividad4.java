...
public class Actividad4 extends AppCompatActivity implements  Response.Listener<JSONObject>,Response.ErrorListener {
    Spinner spinner;
    ImageView imageView  ;
    Button siguiente;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                insertaractiviada4("http://"+ipconexion.getIp()+"/dbandroid/WS/insertaractiviadad4.php?documento="+docuencontrado+"&tipoimagen="+hoja+"&estadoactividad="+estadoactividad+"&fecha="+fecha+"");

                Intent intent = new Intent(Actividad4.this,Actividad4_1.class);
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(Actividad4.this,android.R.layout.simple_spinner_dropdown_item,str);

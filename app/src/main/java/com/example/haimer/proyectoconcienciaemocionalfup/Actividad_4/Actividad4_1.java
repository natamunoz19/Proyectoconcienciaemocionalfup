...
public class Actividad4_1 extends AppCompatActivity  implements  Response.Listener<JSONObject>,Response.ErrorListener{
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Actividad4_1.this,Actividad4_2.class);
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(Actividad4_1.this,android.R.layout.simple_spinner_dropdown_item,str);

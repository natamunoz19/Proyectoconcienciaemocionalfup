...
public class Actividad4_2 extends AppCompatActivity implements  Response.Listener<JSONObject>,Response.ErrorListener{
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Actividad4_2.this,Actividad4_3.class);
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(Actividad4_2.this,android.R.layout.simple_spinner_dropdown_item,str);

...
public class Actividad6_1 extends AppCompatActivity implements  Response.Listener<JSONObject>,Response.ErrorListener{
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad6_1);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                insertaractiviada4("http://"+ipconexion.getIp()+"/dbandroid/WS/insertaractividad6.php?documento="+docuencontrado+"&tipoimagen="+hoja+"&estadoactividad="+estadoactividad+"&fecha="+fecha+"");

                Intent intent = new Intent(Actividad6_1.this,Actividad6_1.class);
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(Actividad6_1.this,android.R.layout.simple_spinner_dropdown_item,str);

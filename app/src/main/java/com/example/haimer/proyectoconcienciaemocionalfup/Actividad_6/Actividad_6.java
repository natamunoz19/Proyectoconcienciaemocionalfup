...
public class Actividad_6 extends AppCompatActivity  implements  Response.Listener<JSONObject>,Response.ErrorListener{
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activiadad_6);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Actividad_6.this,Actividad6_1.class);
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(Actividad_6.this,android.R.layout.simple_spinner_dropdown_item,str);
